<template>
    <form @submit.prevent="storeComment(form.post_id)">
    <div class="my-4 max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
            <section class="text-gray-600 body-font">
                <h6 class="text-2xl pb-4">コメント</h6>
                ...
                <button type="button" class="ml-4 bg-green-300 p-1 rounded btn btn-sm btn-primary">送信する</button>
            </section>
            </div>
        </div>
    </div>
...
const storeComment = id => {
    Inertia.post(`/post/${id}/comments`,form)
}
